...
- The "Hoarder" Rule (Duplicates): while most notebooks only let you have one <_section_>.<_key_> <_value_> per page, Git lets you stick as many as you want if you use a special "plus-sign" instruction ('`git config set --append <section>.<key> <value>`'). *(1)*
  - Commands:
...
- ### 3-Commit History(The Photo Album):
  ...
  - Command: '`git commit -m <message>`' (the <_message_> must be in " " ).
...
## 4-The Workflow Hierarchy: Porcelain and Plumbing (50/40/10 Rule)
...
- ### 50% Solo Mastery: Half of git 
  ##### These are your most common Porcelain commands. Use these to move through your day-to-day workflow
    ...
    - #### '`git diff`': 
      To see what changed in your room.
    - #### '`git add <file-path>`':
    ...
    - #### '`git branch [name]`'(vine branch):
      ...
      - ###### '`git branch -d <name>`': The Safe Eraser. Deletes the branch named in the command, but `-d` refuses if its photos haven't been merged yet.
      - ##### '`git branch -D <name>`':
...
- ..........................................................................................................................................
  - Delivery ('`git push [remote] [branch]`'): Sends local commits from a local branch to a remote branch and advances the remote’s sticky note.
    - '`git push origin main`': Sends local main to remote origin’s main.
    - The local branch stays where it is; only the remote moves.
    - Requires authentication.
    - Advanced forms:
...
- ..........................................................................................................................................
__________
so, based on this entry of mine and this lesson what about this lesson I could add in my _GIT_LEARNING_NOTES.md_ entry to make it more complete? I could give the full _GIT_LEARNING_NOTES.md_ file if you wish.
